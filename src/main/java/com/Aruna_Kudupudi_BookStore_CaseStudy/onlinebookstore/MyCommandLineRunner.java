...
//        imageService.save(file, fromDB.getEmail());
        ...
        Book intro_algo = new Book("Introduction to Algorithms",  15.50,
                "Thomas H. Cormen, Charles E. Leiserson");
//        "Thomas H. Cormen, Charles E. Leiserson, Ronald L. Rivest, Clifford Stein"
        bookRepoI.saveAndFlush(intro_algo);

        // Book 3
        Book scip = new Book("Structure and Interpretation of Computer Programs (SICP)", 12.50,
        ...
        Book code_complete = new Book("Code Complete: A Practical Handbook of Software Construction",
        ...
        Book design_patterns = new Book("Design Patterns: Elements of Reusable Object-Oriented Software)",
